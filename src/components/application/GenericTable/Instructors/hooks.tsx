...
export const useInstructors = (table, tab) => {
  const instructors = [
    { id: '1', Name: 'Test Instructor 1', Institution: 'Test Institution 1' },
    { id: '2', Name: 'Test Instructor 2', Institution: 'Test Institution 2' },
    { id: '3', Name: 'Test Instructor 3', Institution: 'Test Institution 3' }
  ];
